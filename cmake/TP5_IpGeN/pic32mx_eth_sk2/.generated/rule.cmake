...
function(TP5_IpGeN_pic32mx_eth_sk2_pic32mx_eth_sk2_XC32_assemble_rule target)
    set(options
        "-g"
        "${ASSEMBLER_PRE}"
...
function(TP5_IpGeN_pic32mx_eth_sk2_pic32mx_eth_sk2_XC32_assembleWithPreprocess_rule target)
    set(options
        "-x"
        "assembler-with-cpp"
        "-g"
    ...
    list(REMOVE_ITEM options "")
    target_compile_options(${target} PRIVATE "${options}")
    target_compile_definitions(${target} PRIVATE "XPRJ_pic32mx_eth_sk2=pic32mx_eth_sk2")
    target_include_directories(${target} PRIVATE "${CMAKE_CURRENT_SOURCE_DIR}/../../../firmware/TP5_IpGeN.X")
endfunction()
function(TP5_IpGeN_pic32mx_eth_sk2_pic32mx_eth_sk2_XC32_compile_rule target)
    set(options
        "-g"
        "${CC_PRE}"
        "-x"
...
function(TP5_IpGeN_pic32mx_eth_sk2_pic32mx_eth_sk2_XC32_compile_cpp_rule target)
    set(options
        "-g"
        "${CC_PRE}"
        "-mprocessor=32MX795F512L"
...
function(TP5_IpGeN_pic32mx_eth_sk2_link_rule target)
    set(options
        "-g"
        "${MP_EXTRA_LD_PRE}"
        "-mprocessor=32MX795F512L"
